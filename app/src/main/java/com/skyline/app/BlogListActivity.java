...
public class BlogListActivity extends AppCompatActivity {
    ...
    private Blog createEconomyBlog() {
        ...
        b.thumbnailUrl = "android.resource://" + getPackageName() + "/" + R.drawable.phothong_banner;
        ...
        sections.add(createSection(3, "Mỗi hãng hàng không mang đến một chính sách khác nhau", "Dù cùng thuộc hạng Phổ thông, các hãng hàng không có thể áp dụng những chính sách và quyền lợi không giống nhau. Điều kiện đổi ngày, hoàn vé hoặc lựa chọn chỗ ngồi cũng có thể thay đổi theo từng hãng. Vì vậy, hành khách nên kiểm tra kỹ thông tin trước khi thanh toán để hiểu rõ những quyền lợi đã bao gồm.", "blog_pt_3"));
        sections.add(createSection(4, "So sánh đầy đủ để tìm ra chuyến bay phù hợp nhất", "Thông qua Skyline, người dùng có thể xem và so sánh chuyến bay từ nhiều hãng hàng không trên cùng một nền tảng. Các thông tin về hãng bay, giờ khởi hành, thời gian đến, giá vé và điều kiện đi kèm được trình bày trực quan, giúp hành khách dễ dàng đưa ra quyết định phù hợp nhất với mình.", "blog_pt_4"));
        sections.add(createSection(5, "Một quy trình đặt vé nhẹ nhàng cho hành trình thêm an tâm", "Skyline giúp đơn giản hóa quá trình đặt vé từ bước tìm kiếm chuyến bay đến khi hoàn tất thông tin hành khách. Sự rõ ràng trong từng bước giúp hạn chế nhầm lẫn và mang lại cảm giác an tâm hơn khi chuẩn bị cho chuyến đi. Hạng Phổ thông không chỉ là lựa chọn tiết kiệm, mà còn có thể mang đến một hành trình thuận tiện.", "blog_pt_5"));
        b.sections = sections;
    ...
    private Blog createBusinessBlog() {
        ...
        b.thumbnailUrl = "android.resource://" + getPackageName() + "/" + R.drawable.hangthuonggia_banner;
        ...
        List<Blog.Section> sections = new ArrayList<>();
        sections.add(createSection(1, "Trải nghiệm ưu tiên ngay từ sân bay", "Hành khách hạng Thương gia thường được sử dụng quầy làm thủ tục riêng, ưu tiên lên máy bay và nhận hành lý sớm hơn sau khi hạ cánh. Một số hãng còn cung cấp lối ưu tiên tại khu vực kiểm tra an ninh, giúp tiết kiệm thời gian chờ đợi.", "blog_tg_1"));
        sections.add(createSection(2, "Không gian ghế ngồi riêng tư và thoải mái", "Ghế hạng Thương gia thường có kích thước rộng, khoảng cách để chân thoải mái và khả năng điều chỉnh linh hoạt. Trên một số chuyến bay đường dài, ghế có thể ngả thành giường nằm, đi kèm không gian riêng tư và khu vực làm việc tiện lợi.", "blog_tg_2"));
        sections.add(createSection(3, "Dịch vụ và ẩm thực được nâng tầm", "Trải nghiệm hạng Thương gia thường đi kèm phong cách phục vụ chu đáo, thực đơn đa dạng và cách trình bày chỉn chu hơn. Hành khách có thể được lựa chọn suất ăn, đồ uống hoặc đăng ký trước các yêu cầu ăn uống đặc biệt.", "blog_tg_3"));
        sections.add(createSection(4, "Hành lý linh hoạt và phòng chờ tiện nghi", "Vé hạng Thương gia thường có hạn mức hành lý cao hơn. Bên cạnh đó, một số loại vé còn đi kèm quyền sử dụng phòng chờ sân bay với không gian nghỉ ngơi, Wi-Fi, đồ ăn nhẹ và khu vực làm việc yên tĩnh.", "blog_tg_4"));
        sections.add(createSection(5, "Dễ dàng so sánh vé hạng Thương gia trên Skyline", "Trên Skyline, bạn có thể tìm kiếm và so sánh nhiều chuyến bay dựa trên giá vé, thời gian khởi hành, hạn mức hành lý và các điều kiện đi kèm. Nhờ đó, bạn có thể tận hưởng trải nghiệm hạng Thương gia một cách trọn vẹn nhất.", "blog_tg_5"));
        b.sections = sections;
    ...
    private Blog.Section createSection(int num, String title, String desc, String imgResName) {
        ...
        item.imageUrl = "android.resource://" + getPackageName() + "/drawable/" + imgResName;
