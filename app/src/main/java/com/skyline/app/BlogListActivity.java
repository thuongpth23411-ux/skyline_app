...
public class BlogListActivity extends AppCompatActivity {
    ...
    private Blog createEconomyBlog() {
        ...
        b.coverImageUrl = "android.resource://" + getPackageName() + "/" + R.drawable.img_experience_economy;
    ...
    private Blog createBusinessBlog() {
        ...
        b.category = "TRẢI NGHIỆM";
        b.coverImageUrl = "android.resource://" + getPackageName() + "/" + R.drawable.img_experience_first;
        b.thumbnailUrl = b.coverImageUrl;
        ...
        List<Blog.Section> sections = new ArrayList<>();
        sections.add(createSection(1, "Trải nghiệm ưu tiên ngay từ sân bay", "Hành khách hạng Thương gia thường được sử dụng quầy làm thủ tục riêng, ưu tiên lên máy bay và nhận hành lý sớm hơn sau khi hạ cánh. Một số hãng còn cung cấp lối ưu tiên tại khu vực kiểm tra an ninh, giúp tiết kiệm thời gian chờ đợi.", "android.resource://" + getPackageName() + "/" + R.drawable.img_experience_first));
        sections.add(createSection(2, "Không gian ghế ngồi riêng tư và thoải mái", "Ghế hạng Thương gia thường có kích thước rộng, khoảng cách để chân thoải mái và khả năng điều chỉnh linh hoạt. Trên một số chuyến bay đường dài, ghế có thể ngả thành giường nằm, đi kèm không gian riêng tư và khu vực làm việc tiện lợi.", "android.resource://" + getPackageName() + "/" + R.drawable.img_experience_first));
        sections.add(createSection(3, "Dịch vụ và ẩm thực được nâng tầm", "Trải nghiệm hạng Thương gia thường đi kèm phong cách phục vụ chu đáo, thực đơn đa dạng và cách trình bày chỉn chu hơn. Hành khách có thể được lựa chọn suất ăn, đồ uống hoặc đăng ký trước các yêu cầu ăn uống đặc biệt.", "android.resource://" + getPackageName() + "/" + R.drawable.img_experience_first));
        sections.add(createSection(4, "Hành lý linh hoạt và phòng chờ tiện nghi", "Vé hạng Thương gia thường có hạn mức hành lý cao hơn. Bên cạnh đó, một số loại vé còn đi kèm quyền sử dụng phòng chờ sân bay với không gian nghỉ ngơi, Wi-Fi, đồ ăn nhẹ và khu vực làm việc yên tĩnh.", "android.resource://" + getPackageName() + "/" + R.drawable.img_experience_first));
        sections.add(createSection(5, "Dễ dàng so sánh vé hạng Thương gia trên Skyline", "Trên Skyline, bạn có thể tìm kiếm và so sánh nhiều chuyến bay dựa trên giá vé, thời gian khởi hành, hạn mức hành lý và các điều kiện đi kèm. Nhờ đó, bạn có thể tận hưởng trải nghiệm hạng Thương gia một cách trọn vẹn nhất.", "android.resource://" + getPackageName() + "/" + R.drawable.img_experience_first));
        b.sections = sections;
