...
class HomeFragment : Fragment() {
    ...
    private fun setupClicks() = with(binding) {
        ...
        binding.btnAboutUs.setOnClickListener { startActivity(Intent(requireContext(), AboutActivity::class.java)) }

        memberCard.btnRegister.setOnClickListener { startActivity(Intent(requireContext(), RegisterEmailActivity::class.java)) }
        memberCard.tvLogin.setOnClickListener { startActivity(Intent(requireContext(), LoginActivity::class.java)) }
    }
